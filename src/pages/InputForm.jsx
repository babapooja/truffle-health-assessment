...
import { submitBillDetails } from '../lib/service'
...
const InputForm = () => {
 ...
 const isDisabled = () =>{
  if (formData.bill_amount.trim() === '' || formData.city.trim() === '' 
  || formData.fname.trim() === '' || formData.lname.trim() === '' || formData.street_address_2.trim() === '' || formData.street_address_1.trim() === '' || )
  ...
  const onInputChange = (field, value) => {
    ...
    tempD[field] = value;
    if (!tempD.hasOwnProperty('bill_image')) {
      tempD['bill_image'] = '';
    }
